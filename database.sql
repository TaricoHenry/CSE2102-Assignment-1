...
('Frank', 'Origin', '', 'Light Street', 'Xan', 'Georgetown', 4, 21, 'Active'),
...
('Luke', 'Persaud', '', 'Middle Street', 'Patienta', 'West Bank Demerara', 3, 27, 'Active'),
('Henry', 'August', '', 'Well Road', 'Bikini Bottom', 'Undersea', 6, 28, 'Active'),
